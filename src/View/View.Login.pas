...
type
  TFormLogin = class(TForm)
    ...
    procedure edtCadastroEmailKeyDown(Sender: TObject; var Key: Word;
      var KeyChar: Char; Shift: TShiftState);
    procedure edtCadastroSenhaKeyDown(Sender: TObject; var Key: Word;
      var KeyChar: Char; Shift: TShiftState);
...
procedure TFormLogin.edtCadastroEmailKeyDown(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if (Key in [vkReturn, vkTab]) then
  begin
    Focar(edtCadastroSenha);
  end;
end;

procedure TFormLogin.edtCadastroSenhaKeyDown(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if (Key in [vkReturn, vkTab]) then
  begin
    Focar(edtConfirmarSenha);
  end;
end;

procedure TFormLogin.edtConfirmarSenhaKeyDown(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if (Key in [vkReturn, vkTab]) then
  begin
...
procedure TFormLogin.edtNomeCompletoKeyDown(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if (Key in [vkReturn, vkTab]) then
  begin
    Focar(edtCadastroEmail);
  end;
end;
